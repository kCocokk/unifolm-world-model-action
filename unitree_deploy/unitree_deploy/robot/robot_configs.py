...
def d1_opencv_camera_default_factory():
    ...
    环境变量：
      - D1_CAM_DEVICE: '/dev/2' 或 '2' 或 'video2'（默认 /dev/video2）
      - D1_CAMERA_WIDTH: 默认 640
      - D1_CAMERA_HEIGHT: 默认 480
      - D1_CAMERA_FPS: 默认 30
    """
    dev = _normalize_video_device(os.getenv("D1_CAM_DEVICE", "/dev/v4l/by-id/usb-046d_Logitech_Webcam_C925e_504BEDEF-video-index0"))
