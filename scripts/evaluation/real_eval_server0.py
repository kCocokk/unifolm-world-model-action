...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--bs", type=int, default=1, help="Batch size for inference. Must be 1.")
    parser.add_argument("--height", type=int, default=320, help="Height of the generated images in pixels.")
    parser.add_argument("--width", type=int, default=512, help="Width of the generated images in pixels.")
    parser.add_argument(
        "--frame_stride",
        type=int,
        default=3,
        help=(
            "frame stride control for 256 model (larger->larger motion), "
    ...
    parser.add_argument("--video_length", type=int, default=16, help="Number of frames in the generated video.")
    parser.add_argument(
        "--timestep_spacing",
        type=str,
        default="uniform",
        help=(
            "Strategy for timestep scaling. See Table 2 in the paper: "
    ...
    parser.add_argument(
        ...
        default=0.0,
        help=(
            "Rescale factor for guidance as discussed in "
            "'Common Diffusion Noise Schedules and Sample Steps are Flawed' "
            "(https://huggingface.co/papers/2305.08891)."
        ),
    )
    parser.add_argument(
        ...
        default=False,
        help=(
            "Use per-frame autoencoder decoding to reduce GPU memory usage. "
            "Recommended for models with resolutions like 576x1024."
        ),
    )
    return parser
